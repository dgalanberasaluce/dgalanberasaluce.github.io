...
| Raspberry Pi 5B | 4 GB | 500GB SD Nvme             | Raspberry Pi OS (bookworm) | arm64 | ??        |
| Raspberry Pi 5B Rev 1.0| 4 GB | 64GB microSD             | Raspberry Pi OS (bookworm) | arm64 | ??        |
...
| Mac Mini M2 | M2 | 16 GB | 256 GB | macOS | arm64 | ?? |
| Machinist H61 LGA | i3-3220T | 16 GB ddr3 | 256 SSD NVMe + 3 x 1TB HDD |TrueNAS | x86-64 | NAS Server |
